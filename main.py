...
def get_args_parser():
    ...
    parser.add_argument('--debug', action='store_true', 
                        help="For debug only. It will perform only a few steps during trainig and val2017.")
...
def main(args):
    ...
    dataset_val = build_dataset(image_set='val2017', args=args)
    ...
    if args.dataset_file == "coco_panoptic":
        ...
        coco_val = datasets.coco.build("val2017", args)
